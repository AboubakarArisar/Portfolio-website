...
const GithubContributions = () => {
  ...
  const totalContributions = contributions.contributions.reduce((sum, day) => sum + day.count, 0);
    ...
    <div className="w-full md:w-[80vw] mx-auto px-4 py-10">
      ...
      <div className="bg-[#1f1e26] rounded-lg p-6 shadow-2xl">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-semibold text-[#8B8A91]">Contribution Graph</h3>
          <a
        ...
        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-zinc-700/50 shadow-2xl p-4 rounded-lg">
            ...
            <p className="text-2xl font-bold text-zinc-100">{totalContributions}</p>
          </div>
          <div className="bg-zinc-700/50 shadow-2xl p-4 rounded-lg">
            <h4 className="text-[#8B8A91] text-sm">Last Year</h4>
            <p className="text-2xl font-bold text-zinc-100">{lastyearContributions}</p>
          </div>
          <div className="bg-zinc-700/50 shadow-2xl p-4 rounded-lg">
            <h4 className="text-[#8B8A91] text-sm">Longest Streak</h4>
            <p className="text-2xl font-bold text-zinc-100">{longestStreak} days</p>
          </div>
          <div className="bg-zinc-700/50 shadow-2xl p-4 rounded-lg">
            <h4 className="text-[#8B8A91] text-sm">Current Streak</h4>
            <p className="text-2xl font-bold text-zinc-100">{currentStreak} days</p>
          </div>
        </div>
      </div>
    </div>
